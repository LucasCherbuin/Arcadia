...
class OptionsConfig 
{
     ...
     * @return $this
     */
    public function commands(string $name, mixed $value): static
    {
        $this->_usedProperties['commands'] = true;
     ...
     * @return $this
     */
    public function connectionAsync($value): static
    {
     ...
     * @return $this
     */
    public function connectionPersistent($value): static
    {
     ...
     * @return $this
     */
    public function iterableMultibulk($value): static
    {
     ...
     * @return $this
     */
    public function throwErrors($value): static
    {
     ...
     * @return $this
     */
    public function serialization($value): static
    {
     ...
     * @return $this
     */
    public function cluster($value): static
    {
    ...
    /**
     * @default null
     * @param ParamConfigurator|true|'predis'|'sentinel' $value
     * @return $this
     */
    public function replication($value): static
    {
     ...
     * @return $this
     */
    public function slaveFailover($value): static
    {
    ...
    {
        $output = [];
        if (isset($this->_usedProperties['commands'])) {
            $output['commands'] = $this->commands;
        }
