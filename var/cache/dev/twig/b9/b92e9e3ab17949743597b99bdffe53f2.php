...
class __TwigTemplate_5754c01d0899efa5e3bd0bf9cde73cc0 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("headerFooter.html.twig", "admin/utilisateur/new.html.twig", 1);
    ...
    <div class=\"container d-flex justify-content-center align-items-center vh-100\">
        ...
        yield "
                ...
                <div class=\"form-floating mb-3\">
                    ";
        // line 26
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 26, $this->source); })()), "emailPersonnel", [], "any", false, false, false, 26), 'row');
        yield "
                </div>
                ...
                <div class=\"form-floating mb-3\">
                    ";
        // line 30
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 30, $this->source); })()), "role", [], "any", false, false, false, 30), 'row');
        yield "
                </div>
        ...
        yield "
                ...
                <button type=\"submit\" class=\"btn btn-primary w-100\">Creer un nouvel utilisateur</button>
...
";
    ...
    {
        return array (  163 => 42,  157 => 39,  149 => 34,  142 => 30,  135 => 26,  128 => 22,  123 => 20,  116 => 17,  103 => 16,  82 => 5,  77 => 4,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container d-flex justify-content-center align-items-center vh-100\">
        <div class=\"w-100\" style=\"max-width: 500px;\">
            <form method=\"POST\" action=\"{{ path('app_utilisateur_new') }}\">
                <div class=\"form-floating mb-3\">
                    {{ form_row(form.email) }}
                </div>

                <div class=\"form-floating mb-3\">
                    {{ form_row(form.emailPersonnel) }}
                </div>
...
{% endblock %}
", "admin/utilisateur/new.html.twig", "C:\\Users\\Administrateur\\Arcadia\\templates\\admin\\utilisateur\\new.html.twig");
    }
}
