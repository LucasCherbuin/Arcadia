...
class __TwigTemplate_4a66eaae2d143e8daf039cc366ae5611 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("headerFooter.html.twig", "admin/utilisateur/show.html.twig", 1);
...
";
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 16
        yield "    <h1>Détails de l'utilisateur</h1>
    ...
    <ul>
        ...
        if (array_key_exists("utilisateur", $context)) {
            // line 21
            yield "                    ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 21, $this->source); })()), "email", [], "any", false, false, false, 21), "html", null, true);
            yield "
                ";
        } else {
            // line 23
...
";
    ...
    {
        return array (  141 => 28,  137 => 27,  133 => 25,  129 => 23,  123 => 21,  121 => 20,  117 => 19,  112 => 16,  99 => 15,  77 => 4,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('app_utilisateur_edit', { id: utilisateur.id }) }}\" class=\"btn btn-warning\">Modifier</a>
{% endblock %}
", "admin/utilisateur/show.html.twig", "C:\\Users\\Administrateur\\Arcadia\\templates\\admin\\utilisateur\\show.html.twig");
    }
}
